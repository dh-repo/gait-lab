...
describe("ClinicalReportView Component", () => {
  const mockResult: AnalysisResult = {
    ...
    metrics: {
      ...
      symmetryAngle: 3.2,
      harmonicRatioVertical: 2.4,
      harmonicRatioLateral: 1.9,
      harmonicRatio: 2.15,
      stepTimeCV: 0.021,
      strideTimeCV: 0.019,
  ...
  it("renders patient metadata state and form input fields", () => {
    const html = renderToStaticMarkup(
      <ClinicalReportView result={mockResult} patientMeta={mockPatientMeta} />,
    );
  ...
  it("renders executive summary, score ring, ROM table, and clinician sign-off block", () => {
    const html = renderToStaticMarkup(
      <ClinicalReportView result={mockResult} patientMeta={mockPatientMeta} />,
    );

    expect(html).toContain('data-testid="overall-score-ring"');
    expect(html).toContain("Executive Summary");
    expect(html).toContain("Overall Gait Score");
    expect(html).toContain('data-testid="rom-summary-table"');
    ...
    expect(html).toContain("Clinician Verification &amp; Sign-Off");
    expect(html).toContain("Clinician Signature");
    expect(html).toContain("License / NPI #");
    expect(html).toContain(
      "This report is generated by Gait Lab using browser-based computer vision pose estimation.",
    );
  });
