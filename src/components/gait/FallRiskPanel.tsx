...
export function FallRiskPanel({
  ...
  return (
    <div data-testid="fall-risk-panel" className={cn("flex flex-col gap-6 max-w-6xl mx-auto w-full", className)}>
      ...
      <Card className="border-[#DADCE0] bg-white shadow-card overflow-hidden">
        <CardHeader className="bg-[#F8F9FA] px-6 py-4 border-b border-[#DADCE0]">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <div className="flex items-center gap-2">
                <ShieldAlert className="size-5 text-[#1A73E8]" />
                <CardTitle className="text-lg font-bold text-[#202124]">
                  Fall Risk &amp; Acute Motor Weakness Engine
                </CardTitle>
              </div>
              <CardDescription className="text-xs text-[#5F6368] mt-0.5">
            ...
            <div data-testid="model-comparison-toggle" className="inline-flex rounded-lg border border-[#DADCE0] bg-white p-1 shadow-2xs">
              <button
                type="button"
        ...
        <CardContent className="p-4 bg-[#F8F9FA]/50 border-b border-[#DADCE0]">
          <div data-testid="predictive-agreement-badge" className="flex flex-wrap items-center justify-between gap-3 rounded-md border border-[#DADCE0] bg-white p-3 shadow-xs">
            <div className="flex items-center gap-3">
              <Scale className={cn("size-5", isDivergent ? "text-[#B06000]" : "text-[#188038]")} />
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-xs font-bold text-[#202124]">Inter-Model Concordance</span>
                  <Badge
                ...
                <p data-testid="divergence-explanation" className="text-xs text-[#5F6368] mt-0.5">
            ...
            <div className="flex items-center gap-4 text-right">
              <div>
                ...
                <p data-testid="percent-agreement" className="tabular text-base font-bold text-[#202124]">
                  {agreement.percentAgreement}%
                </p>
              </div>
              <div className="border-l border-[#DADCE0] pl-4">
                <span className="text-[10px] uppercase font-semibold text-[#70757A]">Cohen's Kappa (κ)</span>
                <p data-testid="cohens-kappa" className="tabular text-base font-bold text-[#202124]">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        {(activeToggle === "comparison" || activeToggle === "modelA") && (
          <Card data-testid="model-a-card" className="border-[#DADCE0] bg-white shadow-card flex flex-col">
            <CardHeader className="bg-[#F8F9FA] pb-3 border-b border-[#DADCE0]">
              <div className="flex items-center justify-between">
                <CardTitle className="text-base font-semibold text-[#202124]">
            ...
            <CardContent className="p-5 flex-1 flex flex-col justify-between space-y-4">
              ...
              <div className="space-y-2.5">
                <span className="text-xs font-bold text-[#202124] block">Clinical Criteria Checklist</span>

                {/* 1. Gait Speed */}
                <div data-testid="criterion-gait-speed" className="flex items-center justify-between rounded border border-[#DADCE0] bg-[#F8F9FA] p-2 text-xs">
                  <div className="flex items-center gap-2">
                ...
                {/* 2. Step Time CV */}
                <div data-testid="criterion-step-cv" className="flex items-center justify-between rounded border border-[#DADCE0] bg-[#F8F9FA] p-2 text-xs">
                  <div className="flex items-center gap-2">
                ...
                <div data-testid="criterion-double-support" className="flex items-center justify-between rounded border border-[#DADCE0] bg-[#F8F9FA] p-2 text-xs">
                  <div className="flex items-center gap-2">
                ...
                {/* 4. Symmetry Angle */}
                <div data-testid="criterion-symmetry-angle" className="flex items-center justify-between rounded border border-[#DADCE0] bg-[#F8F9FA] p-2 text-xs">
                  <div className="flex items-center gap-2">
              ...
              {/* Model A Summary Bar */}
              <div className="rounded-md border border-[#DADCE0] bg-[#F8F9FA] p-3 text-xs flex justify-between items-center">
                <span className="text-[#5F6368]">Raw Risk Points:</span>
                <span data-testid="model-a-points" className="tabular font-bold text-[#202124] text-sm">
        ...
        {(activeToggle === "comparison" || activeToggle === "modelB") && (
          <Card data-testid="model-b-card" className="border-[#DADCE0] bg-white shadow-card flex flex-col">
            <CardHeader className="bg-[#F8F9FA] pb-3 border-b border-[#DADCE0]">
              <div className="flex items-center justify-between">
                <CardTitle className="text-base font-semibold text-[#202124]">
                  Model B: Composite Index
            ...
            <CardContent className="p-5 flex-1 flex flex-col justify-between space-y-4">
              ...
              <div className="space-y-2 pt-2 border-t border-[#DADCE0]">
                <span className="text-xs font-bold text-[#202124] block">Domain Sub-Scores &amp; Weights</span>

                <div className="grid grid-cols-2 gap-2 text-xs">
                  <div className="rounded border border-[#DADCE0] p-2 bg-[#F8F9FA]">
                    <div className="flex justify-between text-[11px] text-[#5F6368]">
                      <span>Kinematics</span>
                      <span>{(modelB.weights.kinematics * 100).toFixed(0)}%</span>
                    </div>
                    <span data-testid="subscore-kinematics" className="tabular text-sm font-bold text-[#202124] block mt-0.5">
                  ...
                  <div className="rounded border border-[#DADCE0] p-2 bg-[#F8F9FA]">
                    ...
                    <span data-testid="subscore-sway" className="tabular text-sm font-bold text-[#202124] block mt-0.5">
                  ...
                  <div className="rounded border border-[#DADCE0] p-2 bg-[#F8F9FA]">
                    ...
                    <span data-testid="subscore-dte" className="tabular text-sm font-bold text-[#202124] block mt-0.5">
                  ...
                  <div className="rounded border border-[#DADCE0] p-2 bg-[#F8F9FA]">
                    ...
                    <span data-testid="subscore-variability" className="tabular text-sm font-bold text-[#202124] block mt-0.5">
      ...
      <section data-testid="acute-weakness-section" className="space-y-4">
        <div className="flex items-center gap-2">
          <Layers className="size-5 text-[#1A73E8]" />
