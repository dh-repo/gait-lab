...
You are auditor_m4_5_1, a forensic integrity auditor.
...
Perform a full forensic audit of worker_m4_5's changes in Milestone 4 Iteration 5.
Check for:
...
Write your handoff report to `/Users/damian/GitHub/gait-lab/.agents/auditor_m4_5_1/handoff.md` with explicit Verdict (`CLEAN` or `INTEGRITY_VIOLATION`). Send a completion message back with your verdict and path to handoff.md.
